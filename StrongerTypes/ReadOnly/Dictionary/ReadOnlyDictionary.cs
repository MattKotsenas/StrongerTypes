...
{
    // Inspired by http://www.cuttingedge.it/blogs/steven/pivot/entry.php?id=29
    ...
    public class ReadOnlyDictionary<TKey, TValue> : IDictionary<TKey, TValue>, ICollection
    {
        ...
        /// The <see cref="T:Dictionary" /> that will be wrapped.
        /// </param>
        ...
        /// throws a <see cref="T:System.Collections.Generic.KeyNotFoundException" />, and a set operation
        ...
        /// is found; otherwise, the default value for the type of the value parameter. This parameter is
